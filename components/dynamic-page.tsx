    ...
    <>
      ...
      {heroData && (
        <SubpageHero
          ...
          ctaPrimaryLabel={heroData.ctaPrimaryLabel}
          ctaPrimaryHref={heroData.ctaPrimaryHref}
          ctaSecondaryLabel={heroData.ctaSecondaryLabel}
          ctaSecondaryHref={heroData.ctaSecondaryHref}
        >
          {heroData.heroImage && (
            <div className="hidden lg:block w-full max-w-md xl:max-w-lg flex-shrink-0">
              <div className="rounded-2xl overflow-hidden" style={{ boxShadow: "0 12px 48px rgba(0,0,0,0.12)" }}>
